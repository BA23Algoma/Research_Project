...
% Dimensions of the surface we are painting the surface with
surfaceDimCm = 10;
...
% Surface dimensions
surfaceHalfDimCm = surfaceDimCm / 2;

% Surface corner coordinates
surfCoords = [-surfaceHalfDimCm surfaceHalfDimCm 0;...
    surfaceHalfDimCm surfaceHalfDimCm 0;...
    surfaceHalfDimCm -surfaceHalfDimCm 0;...
    -surfaceHalfDimCm -surfaceHalfDimCm 0]';
