...
classdef Maze
    ...
    methods
        ...
        function [coordPoll, isCompleteFlag, stats] = Explore(obj, render, player, inputDevice, coordPollTimeLimit, coordPollInterval, nowNum)
            ...
            while 1
                ...
                coordPoll = coordPoll.Update(player);
        ...
        function Draw(obj)
            ...
            if ~isempty(obj.nWalls)
                ...
                for targetWallIndex = 1:obj.nTargetWalls
                    ...
                    line([obj.targetWallArray(targetWallIndex).p1(1) obj.targetWallArray(targetWallIndex).p2(1)], [obj.targetWallArray(targetWallIndex).p1(2) obj.targetWallArray(targetWallIndex).p2(2)], 'Color', 'k', 'LineWidth', 2);
