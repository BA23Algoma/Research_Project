    ...
    methods
        ...
        function UpdateDisplay(obj, player, maze)
            ...
            if obj.ceilingFlag
                ...
                glBegin(obj.GL.QUADS);
                glTexCoord2f(0.0, 0.0); glVertex3f(-10, 6.0, -10);
                glTexCoord2f(0.0, 1); glVertex3f(-10, 6.0, 10);
                glTexCoord2f(1, 1); glVertex3f(10, 6.0, 10);
                glTexCoord2f(1, 0.0); glVertex3f(10, 6.0, -10);
                glEnd;
                ...
                glTexCoord2f(1, 1); glVertex3f(10, 6.0, -10);
                glTexCoord2f(1, 0.0); glVertex3f(10, 0.0, -10);
                glEnd;
